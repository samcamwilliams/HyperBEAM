...
-define(debug_print(X), hb_formatter:debug_print(X, ?MODULE, ?FUNCTION_NAME, ?LINE)).
...
%% module.
-define(trace(), hb_formatter:trace_macro_helper(fun hb_formatter:print_trace/4, catch error(test), ?MODULE, ?FUNCTION_NAME, ?LINE)).
-define(trace_short(), hb_formatter:trace_macro_helper(fun hb_formatter:print_trace_short/4, catch error(test), ?MODULE, ?FUNCTION_NAME, ?LINE)).
