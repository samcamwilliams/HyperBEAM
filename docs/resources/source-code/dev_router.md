...
<a name="is_exempt-3"></a>

### is_exempt/3 * ###

`is_exempt(Msg1, Msg2, Opts) -> any()`

is_exempt looks at the is_exempt paths opt and if any incoming message path matches it will
